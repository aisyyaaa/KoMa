        ...
        <table class="w-full min-w-full">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    {{-- Provinsi diambil dari relasi Seller yang di-eager load --}}
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            ...
                            {{-- PERBAIKAN: Gunakan reviews_avg_rating dari Controller --}}
                            <span class="ml-1 text-sm font-bold text-gray-900">{{ number_format($product->reviews_avg_rating ?? 0, 1) }}</span>
                            {{-- PERBAIKAN: Gunakan reviews_count dari Controller --}}
