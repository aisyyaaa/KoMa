...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Daftar produk diurutkan berdasarkan rating tertinggi. (SRS-MartPlace-13)</p>
        </div>
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            ...
                            {{-- PERBAIKAN: Gunakan reviews_avg_rating yang dihitung oleh Controller --}}
                            <span class="ml-1 text-sm font-medium text-gray-700">
                                {{ number_format($product->reviews_avg_rating ?? $product->average_rating, 1) }}
                            </span>
                            {{-- Catatan: Asumsi reviews_count sudah tersedia jika menggunakan withAvg --}}
