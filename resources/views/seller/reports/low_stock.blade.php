...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            {{-- Header Utama Halaman disesuaikan --}}
            <p class="text-sm text-gray-500 mt-1">Daftar produk yang stoknya kurang dari 2 unit dan perlu segera dipesan ulang. (SRS-MartPlace-14)</p>
        </div>
        {{-- Tombol Export PDF --}}
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td colspan="4" class="text-center py-12">
                        <h3 class="text-sm font-medium text-gray-900">Tidak ada produk yang perlu segera dipesan.</h3>
