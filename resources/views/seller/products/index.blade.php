...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Kelola dan pantau semua produk toko Anda di sini.</p>
        </div>
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex items-center justify-end space-x-2">
                            <a href="{{ route('seller.products.show', $product->id) }}" class="text-gray-500 hover:text-koma-primary p-1 rounded-full transition duration-150">
